...
namespace Pictor.VertexSource
{
	public sealed class GsvText : IVertexSource
	{
		...
		public double AscenderHeight {
			get { return m_FontSize * .15; }
		}
		public double DescenderHeight {
			get { return m_FontSize * .2; }
		}
		...
		public void Rewind (int nothing)
		{
			...
			m_StartOfGlyphsIndex = m_StartOfIndicesIndex + 257 * 2;
			// one for x one for y
	...
	static internal class CGSVDefaultFont
	{
		public static byte[] gsv_default_font = { 0x40, 0x00, 0x6c, 0x0f, 0x15, 0x00, 0x0e, 0x00, 0xf9, 0xff,
